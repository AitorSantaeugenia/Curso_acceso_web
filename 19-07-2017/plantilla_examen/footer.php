...
<footer class="spacer">
        <div class="container">
            <div class="row">
                <div class="col-sm-5">
                    <h4>Sun house unlimited renting</h4>
                    <p>Confía en nosotros, no elijas a novatos, somos los mejores, egocentricos copiando mierda que encontramos por interent.</p>
                </div>
...
<div class="text-center copyright">By: aitor.j.s.m@gmail.com</a></div>
